...
void SummaryCharts_for_fields_separatley()
{
  ...
  //TFile *file = new TFile("Total2018.root");
  ...
  int color_i=0; int nRuns_with_0_MagField=0, nRunsWithNegativeRuntime_inThisField=90, total_tracks_for_MF = 0, total_events_for_MF = 0;
  ci=TColor::GetColor("#de0b1d");
  
  FILE *MagFields_for_Run = fopen("Events_per_Run_Commissioning2018_Old.csv","r");
 // FILE *MagFields_for_Run = fopen("Events_per_Run.csv","r");
  ...
  std::cout<<"Weighted event Rate for this is :"<<weighted_mean_event_rate<<std::endl;
