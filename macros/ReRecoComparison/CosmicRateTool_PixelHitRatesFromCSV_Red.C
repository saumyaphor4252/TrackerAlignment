void CosmicRateTool_PixelHitRatesFromCSV_Red(const char *CSVfileName, unsigned int runLow = 0, unsigned int runUp = 0) {
  ...
  gr_hit_rate_PIX.SetMarkerColor(kRed);
  ...
  gr_hit_rate_FPIX_disk2_minus.SetMarkerColor(kRed);
  ...
  gr_hit_rate_FPIX_disk3_minus.SetMarkerColor(kRed);
  ...
  gr_hit_rate_BPIX.SetMarkerColor(kRed);
  ...
  gr_hit_rate_BPIX_layer1.SetMarkerColor(kRed);
  ...
  gr_hit_rate_BPIX_layer2.SetMarkerColor(kRed);
  ...
  gr_hit_rate_BPIX_layer3.SetMarkerColor(kRed);
  ...
  gr_hit_rate_BPIX_layer4.SetMarkerColor(kRed);
