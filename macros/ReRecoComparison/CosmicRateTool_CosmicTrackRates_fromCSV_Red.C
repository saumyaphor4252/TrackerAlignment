void CosmicRateTool_CosmicTrackRates_fromCSV_Red(const char* CSVfileName, unsigned int runLow = 0, unsigned int runUp = 0) {
  ...
  gr_track_rate_PIX.SetMarkerColor(kRed);
  ...
  gr_track_rate_BPIX.SetMarkerColor(kRed);
  ...
  gr_track_rate_TOB.SetMarkerColor(kRed);
  ...
  gr_track_rate_TIB.SetMarkerColor(kRed);
  ...
  gr_track_rate_TID.SetMarkerColor(kRed);
  ...
  gr_track_rate_TID_1.SetMarkerColor(kRed);
  ...
  gr_track_rate_TID_2.SetMarkerColor(kRed);
  ...
  gr_track_rate_TID_3.SetMarkerColor(kRed);
  ...
  gr_track_rate_TID_1_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TID_1_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TID_2_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TID_2_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TID_3_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TID_3_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_1.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_2.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_3.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_4.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_5.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_6.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_7.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_8.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_9.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_1_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_1_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_2_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_2_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_3_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_3_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_4_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_4_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_5_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_5_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_6_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_6_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_7_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_7_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_8_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_8_minus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_9_plus.SetMarkerColor(kRed);
  ...
  gr_track_rate_TEC_9_minus.SetMarkerColor(kRed);
