void CosmicRateTool_PixelHitRatesFromCSV_Blue(const char *CSVfileName, unsigned int runLow = 0, unsigned int runUp = 0) {

  FILE *pFile;
  pFile = fopen("tracksInfo_PixelHitRates.txt", "w");
  ...
  std::cout << "Total Runs used: " << j << std::endl;
  ...
  gr_hit_rate.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_PIX.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_FPIX.SetMarkerColor(kBlue);
  ...
  TGraphErrors gr_hit_rate_FPIX_disk1(runNumber_VecD, hit_rate_FPIX_disk1_VecD, runNumber_err_VecD, hit_rate_FPIX_disk1_err_VecD);
  ...
  gr_hit_rate_FPIX_disk1.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_FPIX_disk2.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_FPIX_disk3.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_FPIX_disk1_plus.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_FPIX_disk1_minus.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_FPIX_disk2_plus.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_FPIX_disk2_minus.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_FPIX_disk3_plus.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_FPIX_disk3_minus.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_BPIX.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_BPIX_layer1.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_BPIX_layer2.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_BPIX_layer3.SetMarkerColor(kBlue);
  ...
  gr_hit_rate_BPIX_layer4.SetMarkerColor(kBlue);
  ...
  {
    weight.push_back(hits.at(k) / float(nTotalHits));
  }

  for (int a = 0; a < j; a++)  // Loop over runs(without 0 or negative runtime) to calculate the weighted mean hit rate per PIXEL Layer
  {
