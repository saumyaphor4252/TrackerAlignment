...
//=========  (Sun Oct  3 21:27:25 2021) by ROOT version 6.22/09
   TCanvas *canvas = new TCanvas("canvas", "canvas",1,1,953,842);
   gStyle->SetOptStat(0);
   canvas->Range(-2.246996,-0.07349723,11.71963,0.661475);
   ...
   hb_FPIX__2->SetBinContent(1,0.5599788);
   hb_FPIX__2->SetBinContent(2,0.07857059);
   hb_FPIX__2->SetBinContent(3,0.02968605);
   hb_FPIX__2->SetBinContent(4,0.01394804);
   hb_FPIX__2->SetBinContent(5,0.01573801);
   hb_FPIX__2->SetBinContent(6,0.02683378);
   hb_FPIX__2->SetBinContent(7,0.01290599);
   hb_FPIX__2->SetBinContent(8,0.0139278);
   hb_FPIX__2->SetBinContent(9,0.02205076);
   hb_FPIX__2->SetBinContent(10,0.01032688);
   hb_FPIX__2->SetBinContent(11,0.01172388);
