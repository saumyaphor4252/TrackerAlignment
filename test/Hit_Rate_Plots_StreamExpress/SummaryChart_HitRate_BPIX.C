...
//=========  (Sun Oct  3 21:27:24 2021) by ROOT version 6.22/09
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-1.225634,-0.06972925,6.392523,0.6608713);
   ...
   hb_BPIX__1->SetBinContent(1,0.5599788);
   hb_BPIX__1->SetBinContent(2,0.4814082);
   hb_BPIX__1->SetBinContent(3,0.02983786);
   hb_BPIX__1->SetBinContent(4,0.08841757);
   hb_BPIX__1->SetBinContent(5,0.1461925);
   hb_BPIX__1->SetBinContent(6,0.2169603);
