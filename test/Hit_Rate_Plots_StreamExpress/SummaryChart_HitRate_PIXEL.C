...
//=========  (Sun Oct  3 21:27:25 2021) by ROOT version 6.22/09
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-2.042724,-0.07349723,10.65421,0.661475);
   ...
   hb_PIXEL__3->SetBinContent(1,0.5599788);
   hb_PIXEL__3->SetBinContent(2,0.4814082);
   hb_PIXEL__3->SetBinContent(3,0.02983786);
   hb_PIXEL__3->SetBinContent(4,0.08841757);
   hb_PIXEL__3->SetBinContent(5,0.1461925);
   hb_PIXEL__3->SetBinContent(6,0.2169603);
   hb_PIXEL__3->SetBinContent(7,0.07857059);
   hb_PIXEL__3->SetBinContent(8,0.02968605);
   hb_PIXEL__3->SetBinContent(9,0.02683378);
   hb_PIXEL__3->SetBinContent(10,0.02205076);
