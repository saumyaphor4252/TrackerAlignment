...
//=========  (Sun Oct  3 21:03:48 2021) by ROOT version 6.22/09
   ...
   gStyle->SetOptStat(0);
   can->Range(-1.634179,-0.4160433,8.523364,3.744389);
   can->SetFillColor(0);
   can->SetBorderMode(0);
   can->SetBorderSize(2);
   can->SetGridx();
   ...
   h1b__1->SetBinContent(1,3.169853);
   h1b__1->SetBinContent(2,1.786003);
   h1b__1->SetBinContent(3,0.03496949);
   h1b__1->SetBinContent(4,0.09617312);
   h1b__1->SetBinContent(5,0.8289132);
   h1b__1->SetBinContent(6,0.2227177);
   h1b__1->SetBinContent(7,1.706002);
   h1b__1->SetBinContent(8,0.2822178);
