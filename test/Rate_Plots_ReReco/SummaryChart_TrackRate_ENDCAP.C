...
//=========  (Sun Oct  3 21:03:48 2021) by ROOT version 6.22/09
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-2.508654,-0.007608439,13.21438,0.2542201);
   ...
   hb_ENDCAP__6->SetBinContent(1,0.1115334);
   hb_ENDCAP__6->SetBinContent(2,0.07562151);
   hb_ENDCAP__6->SetBinContent(3,0.07896294);
   hb_ENDCAP__6->SetBinContent(4,0.223133);
   hb_ENDCAP__6->SetBinContent(5,0.1955796);
   hb_ENDCAP__6->SetBinContent(6,0.1714457);
   hb_ENDCAP__6->SetBinContent(7,0.1405188);
   hb_ENDCAP__6->SetBinContent(8,0.122772);
   hb_ENDCAP__6->SetBinContent(9,0.0972642);
   hb_ENDCAP__6->SetBinContent(10,0.06879138);
   hb_ENDCAP__6->SetBinContent(11,0.04789419);
   hb_ENDCAP__6->SetBinContent(12,0.0283153);
